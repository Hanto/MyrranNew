...
public class CustomDebuffDetailsView extends Table implements PropertyChangeListener, Disposable
{
    ...
    public CustomDebuffDetailsView(CustomSpellController customSpellController)
    {
