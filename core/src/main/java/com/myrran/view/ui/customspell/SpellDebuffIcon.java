...
public class SpellDebuffIcon extends Table implements PropertyChangeListener, Disposable
{
    ...
    public SpellDebuffIcon(CustomSpellController customSpellController)
    {
